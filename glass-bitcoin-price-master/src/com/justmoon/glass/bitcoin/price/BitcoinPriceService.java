...
public class BitcoinPriceService extends Service {
    ...
    private class RetrievePriceTask extends AsyncTask<Void, Void, Long> {
    	...
    	protected Long doInBackground(Void... params) {
    		...
    		HttpGet httpGet = new HttpGet("https://coinbase.com/api/v1/prices/spot_rate");
    		...
    		try {
    			...
    			if (statusCode == 200) {
    				...
    				Log.d(TAG, "Got price: " + json.getLong("amount"));
        ...
        protected void onPostExecute(Long result) {
            ...
            mViews.setTextViewText(R.id.source, "Coinbase US "+c.get(Calendar.HOUR)+":"+c.get(Calendar.MINUTE)+
